...
public class BankAccount {
    ...
    public int loadFromText(String filePath) {
        ...
        try {
            ...
            while (fileScanner.hasNextLine()) {
                ...
                tmpAccount.setAccountNumber(lineScanner.nextInt());
                tmpAccount.setBalance(lineScanner.nextDouble());
                tmpAccount.setWithdrawLimit(lineScanner.nextDouble());
                tmpAccount.setDateCreated(lineScanner.next());
                String newName = lineScanner.next();
                char gender = lineScanner.next().charAt(0);
                int newAge = lineScanner.nextInt();
                float newWeight = lineScanner.nextFloat();
                float newHeight = lineScanner.nextFloat();
                String newHairColor = lineScanner.next();
                String newEyeColor = lineScanner.next();
                String newEmail = lineScanner.next();
